...
class World(object):
    ...
    def __init__(self, carla_world, hud, args):
        ...
        self.owns_vehicle = not args.possess_existing_vehicle

    def restart(self, args):
        """Restart the world"""

        # Spawn the player.
        if not args.possess_existing_vehicle:
...
def game_loop(args):
    ...
    wait_for_ego_vehicle = args.possess_existing_vehicle
    next_poll = 0
